...
import com.coding.meet.todo_app.StatusResult.Added
import com.coding.meet.todo_app.StatusResult.Deleted
import com.coding.meet.todo_app.StatusResult.Updated
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val taskAdapter = TaskAdapter(isListMutableLiveData ) { type, position, task ->
            if (type == "delete") {
                taskViewModel
                    // Deleted Task
//                .deleteTask(task)
